...
jQuery(function ($) {
  ...
  if ($("#slider_1").length) {
    ...
    if ($this.is("[data-autoplay]")) {
      ...
      autoplay_val = (ap === true || ap === "true" || ap === 1 || ap === "1")
    }
    // Autoplay timeout.
    if ($this.is("[data-autoplaytimeout]")) {
      autoplaytimeout_val = parseInt($this.data("autoplaytimeout"), 10) || 5500
    }
    ...
    $slider_1.owlCarousel({
      ...
      loop: true,
      autoplay: true,
      autoplayTimeout: autoplaytimeout_val || 5500,
    ...
    // Add initial zoom to first active slide
    setTimeout(function() {
      $slider_1.find(".owl-item.active .slide-bg").addClass("slidezoom")
    }, 150)
    ...
    $slider_animation.on("change.owl.carousel", function (event) {
      ...
      $(".slide-bg").removeClass("slidezoom")
    })
    ...
    $slider_animation.on("translated.owl.carousel", function (e) {
      $(".owl-item.active .slide-bg").addClass("slidezoom")
    })
  }
